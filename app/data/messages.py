...
MESSAGES = [
    {
        "index": 1,
        "text": "Привет, посоветовали вас для монетизации, какие условия?",
        "category": "Продажи",
        "difficulty": "easy"
    },
    {
        "index": 2,
        "text": "А предоплату можно внести с полученных денег, а не сейчас?",
        "category": "Договор",
        "difficulty": "easy"
    },
    {
        "index": 3,
        "text": "Как вы договор подписываете?",
        "category": "Договор",
        "difficulty": "medium"
    },
    {
    ...
    {
        "index": 11,
        "text": "Что делать если на мой канал не одобрится монетизация?\nЯ потеряю предоплату?",
        "category": "Требования",
        "difficulty": "medium"
    },
    {
    ...
    {
        "index": 18,
        "text": "Как долго будет идти подключение?",
        "category": "Риски",
        "difficulty": "hard"
    },
    {
        "index": 19,
        "text": "Вы помогаете со страйками?",
        "category": "Риски",
        "difficulty": "medium"
    },
    {
    ...
    {
        "index": 22,
        "text": "В какие числа у вас выплаты, могу ли в рублях как-то получить?",
        "category": "Выплаты",
        "difficulty": "medium"
    },
    {
    ...
    {
        "index": 33,
        "text": "Как вы считаете курс обмена USDT?\nЯ получу деньги 1:1 как в студии ютуба, минус ваша комиссия?",
        "category": "Доверие",
        "difficulty": "medium"
    },
    {
        "index": 34,
        "text": "Я слышал что у вас менялись условия несколько раз, переживаю что опять измените их в одностороннем порядке",
        "category": "Жалоба",
        "difficulty": "hard"
    },
    {
    ...
    {
        "index": 39,
        "text": "Я к вам привел реферала а выплату за него не получил!",
        "category": "Договор",
        "difficulty": "medium"
    },
    {
    ...
    {
        "index": 41,
        "text": "в какой стране у вас адсенсы?",
        "category": "Требования",
        "difficulty": "medium"
    },
    {
